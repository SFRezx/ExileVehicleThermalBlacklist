...
if (getNumber (configFile >> "CfgSettings" >> "VehicleSpawn" >> "thermalVision") isEqualTo 0 || (_vehicleClass in getArray(missionConfigFile >> "CfgThermalOptions" >> "blacklistedThermals"))) then
{
